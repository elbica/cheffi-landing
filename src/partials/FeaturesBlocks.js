...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 bottom-1/3 md:mt-24 lg:mt-0 bg-carrot-200 pointer-events-none"
        aria-hidden="true"
      ></div>
        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              >
                <g fill="none" fillRule="evenodd">
                  <rect
                    className="fill-current text-carrot-100"
                    width="64"
                    height="64"
                    rx="32"
                  />
                  <g strokeWidth="2">
                    <path
                      className="stroke-current text-ivory-100"
              ...
              <p className="text-gray-600 text-center">
                세상에 레시피들은 많지만, 내가 어떤 걸 요리할 수 있는지 알고싶지
                않나요?
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                이 사이트 저 사이트, 레시피들을 검색하는 일이 불편하지
                않으신가요?
              </p>
            </div>
          </div>
